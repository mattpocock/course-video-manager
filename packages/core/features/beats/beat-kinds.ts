 ...
 *
 * The kinds themselves are domain vocabulary, so they live here; the Lucide
 * icon each one is drawn with is presentation, so that map stays in the
 * application beside the menus that render it.
 */
