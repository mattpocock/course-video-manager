...
describe("pitch create / update", () => {
  ...
  // flag on create/update, and it is stripped from every emitted pitch row
  // (create / update / list / get). The read-only surface lives only in the
  // web UI — the CLI never surfaces it.
